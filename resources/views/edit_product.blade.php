...
<form id="productEditForm" method="POST">
    ...
    <div class="mb-3">
        <img id="imagePrev" alt="Product Image" width="50">
    </div>
    ...
    <button id="delete" type="button" class="btn btn-danger">Delete Product</button>
</form>
</div>
</div>
</div>
...
<script src="{{URL::to('controllers/editProductController.js')}}"></script>
